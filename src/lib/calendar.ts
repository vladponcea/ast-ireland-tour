...
export function generateGoogleCalendarUrl(details: CalendarDetails): string {
  ...
  const params = new URLSearchParams({
    ...
    location: location,
    details: `Join us for the AST Ireland Tour event in ${location}. A day of transformational sales training, networking, and our signature Closing Dinner.`,
  });
...
SUMMARY:${title}
LOCATION:${location}
DESCRIPTION:Join us for the AST Ireland Tour event in ${location}. A day of transformational sales training, networking, and our signature Closing Dinner.
END:VEVENT
END:VCALENDAR`;
...
export function generateOutlookCalendarUrl(details: CalendarDetails): string {
  ...
  const params = new URLSearchParams({
    ...
    location: location,
    body: `Join us for the AST Ireland Tour event in ${location}. A day of transformational sales training, networking, and our signature Closing Dinner.`,
  });
