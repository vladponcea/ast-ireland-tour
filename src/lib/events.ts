...
export const events: Event[] = [
  ...
  },
  {
    ...
    host: "TBD",
    description:
      "The cultural heart of the West. Galway's creative energy and wild Atlantic backdrop fuel transformation. Friday Exclusive Sales Workshop at The Dean Hotel, with an optional Saturday Day at the Galway Races with AST.",
